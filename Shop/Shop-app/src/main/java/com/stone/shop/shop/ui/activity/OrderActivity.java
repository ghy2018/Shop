...
//		shopID = getIntent().getStringExtra("shopID");
    ...
    private void initView() {
        ...
        //获取到当前用户的手机号
        etOrderPhone.setText(BmobUser.getCurrentUser(this, User.class).getPhone());
...
//	}
    ...
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("OrderActivity"); // 保证 onPageEnd 在onPause 之前调用,因为 onPause 中会保存信息
